...
def process_final_dictionary(data):
    ...
    data["mcs_150_mileage_year"] = {
        "mileage": (
            str(data["mcs_150_mileage_year"].split(" ")[0].replace(",", ""))
...
def process_company_snapshot(tree):
    ...
    FIELDS = {
        ...
        ##/html/body/p/table/tbody/tr[2]/td/table/tbody/tr[2]/td/center[1]/table/tbody/tr[11]/td
        "dba_name": "tr[12]/td/text()",
        "physical_address": "tr[13]/td/text()",
        "phone": "tr[14]/td/text()",
        "mailing_address": "tr[15]/td/text()",
        "usdot": "tr[5]/td[1]/text()",
        # /html/body/p/table/tbody/tr[2]/td/table/tbody/tr[2]/td/center[1]/table/tbody/tr[5]/td[1]
    ...
    FIELDS["out_of_service_date"] = process_extracted_text(
        general_info_table.xpath("tr[5]/td[2]/text()")
    )
    ...
    if not isinstance(
        process_extracted_text(general_info_table.xpath("tr[4]/td[1]/text()")), str
    ):
        FIELDS["operating_status"] = process_extracted_text(
            general_info_table.xpath("tr[4]/td[1]/font/b/text()")
        )
    else:
        FIELDS["operating_status"] = process_extracted_text(
            general_info_table.xpath("tr[4]/td[1]/text()")
        )
